...
# Ioniq 5 20-inch controller-independent closed-loop plant tune. Keep the UI parameters at their defaults.
...
IONIQ_5_FF_REDUCTION_LEFT = 0.255
IONIQ_5_FF_REDUCTION_RIGHT = 0.355
IONIQ_5_TURN_IN_BOOST_LEFT = 0.135
IONIQ_5_TURN_IN_BOOST_RIGHT = 0.0
IONIQ_5_UNWIND_TAPER_LEFT = 0.97
IONIQ_5_UNWIND_TAPER_RIGHT = 1.33
IONIQ_5_TURN_IN_THRESHOLD_REDUCTION_LEFT = 0.10
IONIQ_5_TURN_IN_THRESHOLD_REDUCTION_RIGHT = 0.10
IONIQ_5_UNWIND_THRESHOLD_INCREASE_LEFT = 0.32
IONIQ_5_UNWIND_THRESHOLD_INCREASE_RIGHT = 0.36
...
IONIQ_5_CENTER_TAPER_MAX = 0.185
