...
private:
  ...
  QSet<QString> advancedLateralTuneKeys = {"ForceAutoTune", "ForceAutoTuneOff", "ForceTorqueController", "SteerDelay", "SteerFriction", "SteerFrictionJerkGain", "SteerLatAccel", "SteerKP", "SteerRatio"};
  ...
  StarPilotParamValueButtonControl *steerFrictionJerkGainToggle;
